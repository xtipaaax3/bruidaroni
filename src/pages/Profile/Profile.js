      ...
      <div className={styles.header}>
        ...
        <h2 className={styles.count_info}>
          <div className={styles.number_container}>
            ...
            <span>Koga pratite</span>
          </div>
          <div className={styles.number_container}>
            <strong>{user.followers_count}</strong>
            <span>Vaši pratioci</span>
          </div>
          <div className={styles.number_container}>
        ...
        <h2 className={styles.bio}>{user.bio || "Nemate bio."}</h2>
      </div>
      <div className={styles.list_video_wrapper}>
        <div className={styles.title_wrapper}>
          <p className={styles.title}>Videi</p>
          <p className={styles.title}>Lajkovani</p>
        </div>
